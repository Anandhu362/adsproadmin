...
import { Pencil, Trash2, Loader2, Users2, UserPlus, Save, X, AlertTriangle, Search } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        {/* Client Directory List with Search */}
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="relative w-full md:w-64">
                ...
                <Input 
                  ...
                  className="pl-10 h-10 border-slate-200 font-medium text-slate-900 bg-slate-50/50"
                  value={searchTerm}
              ...
              <Table>
                ...
                <TableBody>
                  ...
                  {filteredClients.length === 0 && (
                    <TableRow>
                      <TableCell colSpan={3} className="text-center py-24 text-slate-400 font-bold italic">
                        {searchTerm ? "No matching clients found." : "No client records found."}
                      </TableCell>
                    </TableRow>
                  )}
                </TableBody>
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent className="bg-white border-slate-200 sm:max-w-[400px] shadow-2xl">
          ...
          <DialogFooter className="flex flex-row justify-center gap-3 pt-6 pb-2">
            <Button variant="outline" onClick={() => setIsDeleteDialogOpen(false)} className="flex-1 border-slate-200 font-bold h-11" disabled={isDeleting}>Cancel</Button>
